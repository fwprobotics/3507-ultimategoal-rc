...
@Config
public class Calibrate_Chad extends LinearOpMode {
    //
    DcMotor frontleft;
    DcMotor frontright;
    DcMotor backleft;
    ...
    Double bias = 1.0;//adjust until your robot goes 20 inches  .515
    //
    ...
    public void runOpMode() {
        ...
        waitForStartify();
        //
        moveToPosition(20, .5);//Don't change this line, unless you want to calibrate with different speeds
        //
    }
